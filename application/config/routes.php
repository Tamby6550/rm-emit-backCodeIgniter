...
//Get Engagement
$route['api/getEngagement/(:any)/(:any)/(:any)/(:any)'] = 'api/Engagement/getEngagement/$1/$2/$3/$4';
//Ajout engagement
...
$route['api/getTableauAfficheTableauFinale/(:any)/(:any)/(:any)/(:any)/(:any)'] = 'api/TableauAffiche/getTableauAfficheTableauFinale/$1/$2/$3/$4/$5';
